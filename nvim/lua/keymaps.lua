...
-- Check buffer LSP, formatter, and linter
local diagnostics = require 'utils.diagnostics'
vim.api.nvim_create_user_command('CheckFormatter', diagnostics.check_formatter, {})
vim.api.nvim_create_user_command('CheckLinter', diagnostics.check_linter, {})
vim.api.nvim_create_user_command('CheckLSP', diagnostics.check_lsp, {})
